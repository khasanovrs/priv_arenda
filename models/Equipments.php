...
class Equipments extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['count', 'selling', 'selling_price', 'price_per_day', 'rentals', 'repairs', 'repairs_sum', 'tool_number', 'revenue', 'profit', 'degree_wear', 'payback_ratio', 'countHire', 'is_not_active', 'confirmed', 'count_hire', 'count_repairs'], 'string', 'max' => 45],
