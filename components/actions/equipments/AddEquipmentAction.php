...
class AddEquipmentAction extends Action
{
    public function run()
    {
        ...
        $result = EquipmentsClass::AddEquipmentFields($status, $stock, $equipmentsType, $equipmentsCategory, $count, $tool_number, $selling_price, $price_per_day, $revenue, $degree_wear);
