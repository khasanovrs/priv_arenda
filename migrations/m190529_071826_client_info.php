...
class m190529_071826_client_info extends Migration
{
  ...
  `client_number_passport` varchar(150) COLLATE utf8_bin DEFAULT NULL,
  `client_where_passport` varchar(150) COLLATE utf8_bin DEFAULT NULL,
  `client_date_passport` varchar(150) COLLATE utf8_bin DEFAULT NULL,
  `client_address_passport` varchar(150) COLLATE utf8_bin DEFAULT NULL,
